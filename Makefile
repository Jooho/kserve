...
manifests: controller-gen yq
	...
	cp config/crd/minimal/localmodel/*.yaml charts/kserve-crd-minimal/templates/
	cp config/crd/minimal/localmodel/*.yaml charts/kserve-llmisvc-crd-minimal/templates/
	...
	# Copy the local model crd
	cp config/crd/full/localmodel/serving.kserve.io_localmodelcaches.yaml charts/kserve-crd/templates/
	cp config/crd/full/localmodel/serving.kserve.io_localmodelnodegroups.yaml charts/kserve-crd/templates/
	cp config/crd/full/localmodel/serving.kserve.io_localmodelnodes.yaml charts/kserve-crd/templates/
	cp config/crd/full/localmodel/serving.kserve.io_localmodelcaches.yaml charts/kserve-llmisvc-crd/templates/
	cp config/crd/full/localmodel/serving.kserve.io_localmodelnodegroups.yaml charts/kserve-llmisvc-crd/templates/
	cp config/crd/full/localmodel/serving.kserve.io_localmodelnodes.yaml charts/kserve-llmisvc-crd/templates/
