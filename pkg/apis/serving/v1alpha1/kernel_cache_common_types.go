...
// KernelCacheMountType defines the canonical cache delivery mode.
type KernelCacheMountType string

const (
	// KernelCacheMountTypePVC pulls the OCI image and extracts it to a PVC.
	KernelCacheMountTypePVC KernelCacheMountType = "pvc"

	// KernelCacheMountTypeOCI pulls the OCI image without PVC extraction.
