...
// +kubebuilder:validation:XValidation:rule="self.mountType == oldSelf.mountType",message="mountType is immutable after creation"
...
type KernelCacheSpec struct {
	...
	// MountType is the canonical delivery mode used by node preparation and serving integration.
	// +optional
