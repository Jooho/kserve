...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCacheNodeGroupStorage":      schema_pkg_apis_serving_v1alpha1_KernelCacheNodeGroupStorage(ref),
		"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCacheNodeGroupStorageClass": schema_pkg_apis_serving_v1alpha1_KernelCacheNodeGroupStorageClass(ref),
...
func schema_pkg_apis_serving_v1alpha1_KernelCacheNodeGroupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KernelCacheNodeGroupSpec defines node membership and optional artifact storage for a KernelCacheNodeGroup.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"nodeSelector": {
						SchemaProps: spec.SchemaProps{
					...
					"storage": {
						SchemaProps: spec.SchemaProps{
							Description: "Storage describes how prepared artifacts are persisted on the selected nodes. Leaving Storage unset selects the OCI-only mode: no PersistentVolume or PersistentVolumeClaim is created for the group and KernelCache artifacts are served from container-image storage instead.",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCacheNodeGroupStorage"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCacheNodeGroupStorage", "k8s.io/api/core/v1.Toleration"},
	}
}

func schema_pkg_apis_serving_v1alpha1_KernelCacheNodeGroupStorage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KernelCacheNodeGroupStorage selects one of two mutually exclusive storage modes for the group:\n\n  - StorageClass mode:  dynamic provisioning through a named StorageClass.\n    Use this when the cluster has a working dynamic provisioner and the\n    operator should own volume lifecycle.\n  - Verbatim mode:      caller-supplied PersistentVolume and\n    PersistentVolumeClaim templates, mirroring the shape used by\n    LocalModelNodeGroup. Use this when the cluster does not have a suitable\n    dynamic provisioner and volumes must be pinned to individual nodes\n    (typically Local PVs).\n\nExactly one of StorageClass or PersistentVolumeSpec must be set. PersistentVolumeClaimSpec is required whenever PersistentVolumeSpec is set. hostPath volumes are rejected in verbatim mode; use Local PVs instead.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"storageClass": {
						SchemaProps: spec.SchemaProps{
							Description: "StorageClass configures dynamic provisioning of one PersistentVolume per selected node from a named StorageClass. Mutually exclusive with the verbatim fields below.",
							Ref:         ref("github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCacheNodeGroupStorageClass"),
						},
					},
					"persistentVolumeSpec": {
						SchemaProps: spec.SchemaProps{
							Description: "PersistentVolumeSpec is the template used to create one PersistentVolume per selected node in verbatim mode. Mirrors the field of the same name on LocalModelNodeGroup so existing operator plumbing can be reused. Must describe a Local PV (or another node-scoped source); hostPath is rejected.",
							Ref:         ref("k8s.io/api/core/v1.PersistentVolumeSpec"),
						},
					},
					"persistentVolumeClaimSpec": {
						SchemaProps: spec.SchemaProps{
							Description: "PersistentVolumeClaimSpec is the template used to create one PersistentVolumeClaim per selected node in verbatim mode. Required whenever PersistentVolumeSpec is set.",
							Ref:         ref("k8s.io/api/core/v1.PersistentVolumeClaimSpec"),
						},
					},
					"storageLimit": {
						SchemaProps: spec.SchemaProps{
							Description: "StorageLimit caps the per-node disk usage in verbatim mode. Interpreted the same way as LocalModelNodeGroup.Spec.StorageLimit. It is not valid in StorageClass mode, where StorageClass.Size provides the capacity.",
		...
		Dependencies: []string{
			"github.com/kserve/kserve/pkg/apis/serving/v1alpha1.KernelCacheNodeGroupStorageClass", "k8s.io/api/core/v1.PersistentVolumeClaimSpec", "k8s.io/api/core/v1.PersistentVolumeSpec", "k8s.io/apimachinery/pkg/api/resource.Quantity"},
	}
}

func schema_pkg_apis_serving_v1alpha1_KernelCacheNodeGroupStorageClass(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KernelCacheNodeGroupStorageClass configures dynamic provisioning through a named StorageClass.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the StorageClass name used to provision node-local volumes.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"size": {
						SchemaProps: spec.SchemaProps{
							Description: "Size is the requested capacity for each provisioned volume.",
							Ref:         ref("k8s.io/apimachinery/pkg/api/resource.Quantity"),
						},
					},
					"accessModes": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "AccessModes are the requested access modes for the provisioned volumes.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
				...
				Required: []string{"name", "accessModes"},
			},
		},
		Dependencies: []string{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"mountType": {
						SchemaProps: spec.SchemaProps{
							Description: "MountType is the canonical delivery mode used by node preparation and serving integration.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"mountType": {
						SchemaProps: spec.SchemaProps{
							Description: "MountType is the observed effective mount type.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"defaultNodeGroup": {
						SchemaProps: spec.SchemaProps{
							Description: "DefaultNodeGroup is used when an automatically created KernelCache has no workload override.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"abandonedCapturePolicy": {
						SchemaProps: spec.SchemaProps{
							Description: "AbandonedCapturePolicy controls generated captures whose producer Pod disappears before completion.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
