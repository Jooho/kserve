...
var runtimeConfigFactorDefinitions = []FactorDefinition{
	{Key: TensorParallelSizeFactor, OptionAliases: []string{"--tensor-parallel-size", "--tensor_parallel_size", "-tp", "--tp"}, ValueType: factorValueInteger},
	{Key: PipelineParallelSizeFactor, OptionAliases: []string{"--pipeline-parallel-size", "--pipeline_parallel_size", "-pp", "--pp"}, ValueType: factorValueInteger},
	{Key: MaxModelLenFactor, OptionAliases: []string{"--max-model-len", "--max_model_len"}, ValueType: factorValueInteger},
	{Key: DTypeFactor, OptionAliases: []string{"--dtype"}, ValueType: factorValueString},
	{Key: QuantizationFactor, OptionAliases: []string{"--quantization", "-q"}, ValueType: factorValueString},
	{Key: QuantizationConfigFactor, OptionAliases: []string{"--quantization-config", "--quantization_config"}, ValueType: factorValueHash},
	{Key: KVCacheDTypeFactor, OptionAliases: []string{"--kv-cache-dtype", "--kv_cache_dtype"}, ValueType: factorValueString},
	{Key: BlockSizeFactor, OptionAliases: []string{"--block-size", "--block_size"}, ValueType: factorValueInteger},
	{Key: MaxNumBatchedTokensFactor, OptionAliases: []string{"--max-num-batched-tokens", "--max_num_batched_tokens"}, ValueType: factorValueInteger},
	{Key: MaxNumSeqsFactor, OptionAliases: []string{"--max-num-seqs", "--max_num_seqs"}, ValueType: factorValueInteger},
	{Key: ChunkedPrefillFactor, OptionAliases: []string{"--enable-chunked-prefill", "--enable_chunked_prefill"}, ValueType: factorValueBoolean},
	{Key: DisableSlidingWindowFactor, OptionAliases: []string{"--disable-sliding-window", "--disable_sliding_window"}, ValueType: factorValueBoolean},
	{Key: EnforceEagerFactor, OptionAliases: []string{"--enforce-eager", "--enforce_eager"}, ValueType: factorValueBoolean},
	{Key: AttentionBackendFactor, OptionAliases: []string{"--attention-backend", "--attention_backend"}, ValueType: factorValueString},
	{Key: CompilationConfigFactor, OptionAliases: []string{"--compilation-config", "--compilation_config", "-cc"}, ValueType: factorValueHash},

	{Key: "env.VLLM_USE_AOT_COMPILE", EnvironmentName: "VLLM_USE_AOT_COMPILE", ValueType: factorValueBoolean},
	{Key: "env.VLLM_USE_MEGA_AOT_ARTIFACT", EnvironmentName: "VLLM_USE_MEGA_AOT_ARTIFACT", ValueType: factorValueBoolean},
	{Key: "env.VLLM_USE_STANDALONE_COMPILE", EnvironmentName: "VLLM_USE_STANDALONE_COMPILE", ValueType: factorValueBoolean},
	{Key: "env.VLLM_ENABLE_PREGRAD_PASSES", EnvironmentName: "VLLM_ENABLE_PREGRAD_PASSES", ValueType: factorValueBoolean},
	{Key: "env.VLLM_ENABLE_INDUCTOR_MAX_AUTOTUNE", EnvironmentName: "VLLM_ENABLE_INDUCTOR_MAX_AUTOTUNE", ValueType: factorValueBoolean},
	{Key: "env.VLLM_ENABLE_INDUCTOR_COORDINATE_DESCENT_TUNING", EnvironmentName: "VLLM_ENABLE_INDUCTOR_COORDINATE_DESCENT_TUNING", ValueType: factorValueBoolean},
	{Key: "env.VLLM_FLOAT32_MATMUL_PRECISION", EnvironmentName: "VLLM_FLOAT32_MATMUL_PRECISION", ValueType: factorValueString},
	{Key: "env.VLLM_BATCH_INVARIANT", EnvironmentName: "VLLM_BATCH_INVARIANT", ValueType: factorValueBoolean},
	{Key: "env.VLLM_TRITON_USE_TD", EnvironmentName: "VLLM_TRITON_USE_TD", ValueType: factorValueBoolean},
	{Key: "env.VLLM_DISABLED_KERNELS", EnvironmentName: "VLLM_DISABLED_KERNELS", ValueType: factorValueCommaSeparated},
	{Key: "env.VLLM_PP_LAYER_PARTITION", EnvironmentName: "VLLM_PP_LAYER_PARTITION", ValueType: factorValueString},
}
