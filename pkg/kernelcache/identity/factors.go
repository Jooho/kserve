...
// RuntimeConfigFactorDefinitions returns a copy of the supported factor catalog.
func RuntimeConfigFactorDefinitions() []FactorDefinition {
	return append([]FactorDefinition(nil), runtimeConfigFactorDefinitions...)
}
...
// ParseRuntimeConfigFactors reads known runtime options and allowlisted environment
...
func ExtractRuntimeConfigFactors(container *corev1.Container) map[string]string {
	...
	return ParseRuntimeConfigFactors(container.Command, container.Args, environment)
}
