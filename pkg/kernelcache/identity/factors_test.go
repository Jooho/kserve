...
func TestExtractRuntimeFactors(t *testing.T) {
	factors := ExtractRuntimeFactors(
...
func TestExtractRuntimeFactorsUsesLastOptionValue(t *testing.T) {
	factors := ExtractRuntimeFactors(
...
func TestExtractRuntimeFactorsIgnoresUnsupportedAndInvalidValues(t *testing.T) {
	factors := ExtractRuntimeFactors(
