...
manifests: controller-gen kustomize yq
	...
	@$(CONTROLLER_GEN) rbac:roleName=kserve-kernelcache-registry-bootstrap paths=./pkg/controller/v1alpha1/kernelcache output:rbac:artifacts:config=config/rbac/kernelcache
