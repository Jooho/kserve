...
from .utils import add_kustomize_labels, quote_label_value_if_needed, yaml_to_string
...
class WorkloadGenerator:
    ...
    def generate_deployment(self, output_dir: Path, component_name: str,
    ...
    def generate_daemonset(self, output_dir: Path, component_name: str,
                          component_data: Dict[str, Any]) -> None:
        ...
        if 'annotations' in daemonset['spec']['template']['metadata']:
            template += '      annotations:\n'
            for key, value in daemonset['spec']['template']['metadata']['annotations'].items():
                template += f'        {key}: {value}\n'
    ...
    def _generate_workload_header(self, workload: Dict[str, Any], is_main_component: bool,
    ...
    def _generate_container_spec(self, container: Dict[str, Any], is_main_container: bool,
                                  component_config: Dict[str, Any], workload_type: str = 'deployment') -> str:
