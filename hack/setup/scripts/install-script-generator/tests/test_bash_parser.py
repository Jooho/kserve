...
class TestBashParser(unittest.TestCase):
    ...
    def test_deduplicate_variables_no_duplicates(self):
        """Test deduplicating when no duplicates exist."""
        variables = [
            "VAR1=value1",
            "VAR2=value2",
            "VAR3=value3"
    ...
    def test_deduplicate_variables_empty(self):
        """Test deduplicating empty list."""
        result = bash_parser.deduplicate_variables([])
        self.assertEqual(result, [])

    def test_deduplicate_variables_keeps_first(self):
    ...
    def test_deduplicate_variables_different_values(self):
        """Test deduplicating variables with different values."""
        variables = [
        ...
        self.assertEqual(result[0], "ISTIO_VERSION=1.20.0")
        self.assertEqual(result[1], "KEDA_VERSION=2.10.0")

    def test_deduplicate_variables_array_single_line(self):
        """Test deduplicating array declared on single line."""
        variables = [
            "TOOLS=(kubectl helm)",
            "VERSION=1.0"
        ]
