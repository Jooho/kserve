...
from pkg import template_engine
...
class TestTemplateEngine(unittest.TestCase):
    ...
    def test_replace_placeholders_special_chars(self):
        """Test replacement with special characters."""
        template = "Path: {{PATH}}"
        replacements = {"PATH": "/home/user/test"}
        result = template_engine.replace_placeholders(template, replacements)
        self.assertEqual(result, "Path: /home/user/test")

    def test_replace_placeholders_multiline(self):
        """Test multiline template replacement."""
