...
#
# AUTO-GENERATED from: kserve-keda-dependency-install.definition
# DO NOT EDIT MANUALLY
#
# To regenerate:
#   ./scripts/generate-install-script.py kserve-keda-dependency-install.definition
#
# Usage: kserve-keda-dependency-install.sh [--reinstall|--uninstall]
