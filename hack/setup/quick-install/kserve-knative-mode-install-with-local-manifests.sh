...
# Install KServe Knative Mode dependencies using helm and kserve using kustomize.
#
...
main() {
    ...
    echo "=========================================="
    echo "Install KServe Knative Mode dependencies using helm and kserve using kustomize."
    echo "=========================================="
