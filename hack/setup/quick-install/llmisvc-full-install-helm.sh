...
# Install LLM InferenceService dependencies using helm and kserve using helm
#
...
main() {
    ...
    echo "=========================================="
    echo "Install LLM InferenceService dependencies using helm and kserve using helm"
    echo "=========================================="
